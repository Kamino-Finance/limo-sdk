...
export const NULL_PUBKEY = new PublicKey(
...
export function isNotNullPubkey(pubkey: PublicKey): boolean {
  return (
    pubkey && !pubkey.equals(NULL_PUBKEY) && !pubkey.equals(PublicKey.default)
  );
}
...
export class HashablePublicKey
  extends PublicKey
  implements IEquality<HashablePublicKey>
{
