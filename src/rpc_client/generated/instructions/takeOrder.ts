...
export const TAKE_ORDER_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  163, 208, 20, 172, 223, 65, 255, 228,
]);

export function getTakeOrderDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(TAKE_ORDER_DISCRIMINATOR);
}

export type TakeOrderInstruction<
...
export type TakeOrderInstructionData = {
...
export type TakeOrderInstructionDataArgs = {
  inputAmount: number | bigint;
  minOutputAmount: number | bigint;
  tipAmountPermissionlessTaking: number | bigint;
};

export function getTakeOrderInstructionDataEncoder(): FixedSizeEncoder<TakeOrderInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: TAKE_ORDER_DISCRIMINATOR }),
  );
}

export function getTakeOrderInstructionDataDecoder(): FixedSizeDecoder<TakeOrderInstructionData> {
...
export function getTakeOrderInstructionDataCodec(): FixedSizeCodec<
  TakeOrderInstructionDataArgs,
  TakeOrderInstructionData
> {
  return combineCodec(
    getTakeOrderInstructionDataEncoder(),
    getTakeOrderInstructionDataDecoder(),
  );
}

export type TakeOrderAsyncInput<
...
> = {
  ...
  inputAmount: TakeOrderInstructionDataArgs["inputAmount"];
  minOutputAmount: TakeOrderInstructionDataArgs["minOutputAmount"];
  tipAmountPermissionlessTaking: TakeOrderInstructionDataArgs["tipAmountPermissionlessTaking"];
};

export async function getTakeOrderInstructionAsync<
  TAccountTaker extends string,
  TAccountMaker extends string,
  TAccountGlobalConfig extends string,
  TAccountPdaAuthority extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getTakeOrderInstructionDataEncoder().encode(
      args as TakeOrderInstructionDataArgs,
    ),
    programAddress,
  } as TakeOrderInstruction<
    TProgramAddress,
    TAccountTaker,
    TAccountMaker,
    TAccountGlobalConfig,
...
export function getTakeOrderInstruction<
  TAccountTaker extends string,
  TAccountMaker extends string,
  TAccountGlobalConfig extends string,
  TAccountPdaAuthority extends string,
...
export type ParsedTakeOrderInstruction<
  TProgram extends string = typeof LIMO_PROGRAM_ADDRESS,
...
export function parseTakeOrderInstruction<
...
>(
  ...
  return {
    ...
    data: getTakeOrderInstructionDataDecoder().decode(instruction.data),
  };
}
