...
export const FLASH_TAKE_ORDER_START_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([126, 53, 176, 15, 39, 103, 97, 243]);

export function getFlashTakeOrderStartDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    FLASH_TAKE_ORDER_START_DISCRIMINATOR,
  );
}

export type FlashTakeOrderStartInstruction<
...
export type FlashTakeOrderStartInstructionData = {
...
export type FlashTakeOrderStartInstructionDataArgs = {
  inputAmount: number | bigint;
  minOutputAmount: number | bigint;
  tipAmountPermissionlessTaking: number | bigint;
};

export function getFlashTakeOrderStartInstructionDataEncoder(): FixedSizeEncoder<FlashTakeOrderStartInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: FLASH_TAKE_ORDER_START_DISCRIMINATOR,
    }),
  );
}

export function getFlashTakeOrderStartInstructionDataDecoder(): FixedSizeDecoder<FlashTakeOrderStartInstructionData> {
...
export function getFlashTakeOrderStartInstructionDataCodec(): FixedSizeCodec<
  FlashTakeOrderStartInstructionDataArgs,
  FlashTakeOrderStartInstructionData
> {
  return combineCodec(
    getFlashTakeOrderStartInstructionDataEncoder(),
    getFlashTakeOrderStartInstructionDataDecoder(),
  );
}

export type FlashTakeOrderStartAsyncInput<
...
> = {
  ...
  inputAmount: FlashTakeOrderStartInstructionDataArgs["inputAmount"];
  minOutputAmount: FlashTakeOrderStartInstructionDataArgs["minOutputAmount"];
  tipAmountPermissionlessTaking: FlashTakeOrderStartInstructionDataArgs["tipAmountPermissionlessTaking"];
};

export async function getFlashTakeOrderStartInstructionAsync<
  TAccountTaker extends string,
  TAccountMaker extends string,
  TAccountGlobalConfig extends string,
  TAccountPdaAuthority extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getFlashTakeOrderStartInstructionDataEncoder().encode(
      args as FlashTakeOrderStartInstructionDataArgs,
    ),
    programAddress,
  } as FlashTakeOrderStartInstruction<
    TProgramAddress,
    TAccountTaker,
    TAccountMaker,
    TAccountGlobalConfig,
...
export type FlashTakeOrderStartInput<
  TAccountTaker extends string = string,
  TAccountMaker extends string = string,
  TAccountGlobalConfig extends string = string,
  TAccountPdaAuthority extends string = string,
...
export function getFlashTakeOrderStartInstruction<
  TAccountTaker extends string,
  TAccountMaker extends string,
  TAccountGlobalConfig extends string,
  TAccountPdaAuthority extends string,
  ...
  TProgramAddress extends Address = typeof LIMO_PROGRAM_ADDRESS,
>(
  input: FlashTakeOrderStartInput<
    TAccountTaker,
    TAccountMaker,
    TAccountGlobalConfig,
    TAccountPdaAuthority,
...
export type ParsedFlashTakeOrderStartInstruction<
  TProgram extends string = typeof LIMO_PROGRAM_ADDRESS,
...
> = {
  ...
  data: FlashTakeOrderStartInstructionData;
};

export function parseFlashTakeOrderStartInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedFlashTakeOrderStartInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getFlashTakeOrderStartInstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
